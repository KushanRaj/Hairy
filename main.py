...
class Trainer:
    ...
    def re__init(self,epoch_path,div_loss_path):
        ...
        self.model.load(f'{self.config["weight_save"]}/{self.config["model"]}/{self.epochs}')

    def _run(self):
        print ("start training")
        epoch = self.epochs
        sampler = iter(self.val_dataloader)
...
if __name__ == "__main__":
    ...
    #trainer.re__init('E:/Hairy/epochs/epoch.npy','E:/Hairy/div_wt/div.npy')
    trainer._run()
